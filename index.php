...
<body>
    ...
    <div id="carouselControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner text-center">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images\laundry121.jpg">
            </div>
            <div class="carousel-caption">
                <h6><img src="images/LOGO2.png" width="350px"> </h6>
                    <h1><a class="display-4 "<!--text-light bg-dark--><b> Selamat Datang di LONDO</b></a></h1>
                    <br>
                    <h1><a class="text-light "<!--bg-dark-->Laundry Online Setiap Hari</a></h1>
                <br>
                <h6><a class="btn btn-primary btn-lg" href="signup.php" role="button">Daftar Sekarang</a></h6>
                <br><br><br><br><br>
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/laundry123.jpg">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/laundry221.jpg">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/laundry331.jpg">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/laundry421.jpg">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/laundry661.jpg">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm">
                    ...
                    <p>Tambakan, Sinduharjo, Kec. Ngaglik, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55581</p>
                    <br>
                    <h4>
                        <b>Nomor Telepon :</b>
                    </h4>
                    <p><img src="images/LOGOWA.png" width="40px"><a style="color: white; " href="https://api.whatsapp.com/send/?phone=6282279363009&text&type=phone_number&app_absent=0">082279363009</a></p>
                    <br>
                    <h4>
                        <b>Follow Us! :</b>
                    </h4>
                    <p><img src="images/img11.png" width="40px"><a style="color: white; " href="https://www.instagram.com/sae_creative_id">sae_creative_id</a></p>
   ...
   <!-- Footer -->
    ...
    function initialize() {
        var propertiPeta = {
            center:new google.maps.LatLng(-7.728096, 110.401362),
            zoom:15,
        ...
        var marker=new google.maps.Marker({
            position: new google.maps.LatLng(-7.728096, 110.401362),
            map: peta,
